...
:: --------------------------------------
set "webhook=YOUR WEBHOOK LINK"
:: EX: https://discord.com/api/webhooks/1235658661972541498/QbKqxHiCqCqFZ0oWmV8NrndO0gvm9-FRdwopydXc7PJQ6kpYtmOzAiZpoxCUaabRhrjY
